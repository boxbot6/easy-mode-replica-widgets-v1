...
[Download the widgets (they're free!)](https://github.com/boxbot6/easy-mode-replica-widgets-v1/raw/main/downloads/easy-mode-replica-widgets-v1.zip)
...
Shown above working on my Samsung Galaxy S5, but should work on any make of phone that can use the KWGT app. (I also used some extra optional settings above that are described later below in **'Additional Setup For The Easy Mode Look'** including using 'Nova Launcher' to adjust the grid dimensions of the icons).
...
* folder of additional-files (includes S4 Icon Pack)
...
- To get the weather location working (and showing the correct icons) you may have to turn the phones location off and on again.
...
This widget contains my 'easy-weather-icons-font.ttf' to show the weather conditions, it can be found free for use elsewhere at this link: <https://boxbot6.github.io/easy-weather-icons-font-v1> (example below).
...
\* Sorry - the standalone app and its repository are not yet finished! \*
